...
render.addImageSource("easy_on")
render.addImageSource("easy_off")
render.addImageSource("expert_on")
render.addImageSource("expert_off")
...
sound.addSoundSource("button_press","Cabinet Lock Sfx")
sound.addSoundSource("stage_clear","Accept")
sound.addSoundSource("stage_incorrect","Error-or-failed")
sound.addSoundSource("light_press","Cabinet Lock Sfx")
sound.addSoundSource("award_fall","light")
sound.addSoundSource("light_fall","Jump 1")
sound.addSoundSource("gui_fall","Metal-Hit")
